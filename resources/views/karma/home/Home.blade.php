            ...
            <div class="row justify-content-center">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8">
                            <div class="single-deal">
                                ...
                                <a href="{{asset('/')}}/karma/img/category/c1.jpg" class="img-pop-up" target="_blank">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="single-deal">
                                ...
                                <a href="{{asset('/')}}/karma/img/category/c2.jpg" class="img-pop-up" target="_blank">
                                    <div class="deal-details">
                                        <h6 class="deal-title">Sneaker for Sports</h6>
                                    </div>
                                </a>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="single-deal">
                                ...
                                <a href="{{asset('/')}}/karma/img/category/c3.jpg" class="img-pop-up" target="_blank">
                                    <div class="deal-details">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <div class="single-deal">
                                ...
                                <a href="{{asset('/')}}/karma/img/category/c4.jpg" class="img-pop-up" target="_blank">
                                    <div class="deal-details">
                                        <h6 class="deal-title">Sneaker for Sports</h6>
                                    </div>
                                </a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-deal">
                        ...
                        <a href="{{asset('/')}}/karma/img/category/c5.jpg" class="img-pop-up" target="_blank">
                            <div class="deal-details">
                                <h6 class="deal-title">Sneaker for Sports</h6>
                            </div>
                        </a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product">
                            <img  src="{{asset($products->product_image)}}" alt="" height="250px" width="250px">
                            <div class="product-details">
                                <h6>{{$products->proudct_name}}</h6>
                                <div class="price">
                                    <h6>TK. {{$products->product_price}}</h6>
